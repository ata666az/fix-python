...
# 环境变量
UUID = os.environ.get('UUID', 'efa42a1b-7142-4c04-b3b4-ac666b9560ad')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'ataws.ata666az.deno.net')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
